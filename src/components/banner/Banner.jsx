...
const Banner = ({handleCoins}) => {
    return (
        <div className="relative">
            ...
            border-2 border-gray-500 hover:bg-sky-950 hover:text-white hover:border-amber-300 rounded-lg px-2 py-1 " 
            onClick={()=>handleCoins(10000)}>Claim free credits</button>
        </div>
    );
};
